...
module.exports = {
    ...
    async execute(message, args, config) {
        if(!args[2] || args[3]!=undefined) return message.channel.send(`Use \`${config.prefix}config reactionRole setChannel {channel_name/#channel}\` to run this command correctly`);
